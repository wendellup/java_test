...
//        System.out.println(Utils.getFileId("/677/0b29656dh199a3e6", 0));
    	String terminalIdStr = "1";
    	String gameIdStr = "5009048";
    	String loginUserIdStr = "1027729";
    	String validTimeStr = "123545";
    	String calcValidCode = Utils.encryptMD5(terminalIdStr + gameIdStr + loginUserIdStr + validTimeStr + "egameDownload");
    	System.out.println(calcValidCode);
