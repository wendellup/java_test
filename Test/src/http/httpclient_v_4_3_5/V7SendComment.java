...
public class V7SendComment {
	public static Logger logger = Logger.getLogger(V7SendComment.class);
	...
	public static void main_3(String[] args){
	    try {
	        ...
	        params.add(new BasicNameValuePair("content", URLEncoder.encode(new RandomHan().getRandomString(), "utf-8")));
	        params.add(new BasicNameValuePair("access_token", getRandomAccessToken()));
	...
	public static void main2(String[] args) {
		System.out.println(getRandomAccessToken());;
	}
	
	private static String getRandomAccessToken() {
		String access_token = "";
		String accessTokenUrl = "http://192.168.251.52:8102/oauth/access_token?grant_type=password&client_id=8888007&client_secret=3490de538da6a59c723b6cb092b210&fromer=10010107";
		Random ran = new Random();
		String imsi = ran.nextLong()+"";
		accessTokenUrl = accessTokenUrl + "&imsi="+imsi;
		try {
			
			ObjectMapper jsonMapper = new ObjectMapper();
			jsonMapper.configure(JsonParser.Feature.ALLOW_SINGLE_QUOTES , true); 
			String content = encode(HttpUtils.httpGet(accessTokenUrl), "UTF-8");
...
class RandomHan {
    ...
    public String getRandomString() {
    	...
    	int len = ran.nextInt(20)+ran.nextInt(10)+1;
        for(int i=0; i<len; i++){
