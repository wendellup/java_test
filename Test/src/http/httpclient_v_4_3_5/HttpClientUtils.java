...
//		case HttpStatus.SC_MULTI_STATUS:
	...
	public static void main(String[] args) throws ClientProtocolException, IOException, URISyntaxException {
		//get请求
//		String url = "http://open.play.cn/api/v2/mobile/gift/list_game_gift.json?current_page=0&rows_of_page=20&game_id=5040628&access_token=eb704c7b3412553e94bc8708a179c061";
//		System.out.println(simpleGetInvoke(url, new HashMap<String, String>()));
		//post请求
		String url = "http://open.play.cn/api/v2/mobile/game/check_version.json";
		Map<String, String> map = new HashMap<String, String>();
		map.put("packages", "[{\"sh.lilith.dgame.aiyouxi\":1}]");
